...
CaseName    =   "test_WebPage_CreateAndCheck_External"
...
class Test(unittest.TestCase):
    ...
    # Test Steps Here
    def test_WebPage_CreateAndCheck_External(self):
        ...
        UCDN1.CreateUCDN_SelectArea(Area=u"国外")
        UCDN1.CreateUCDN_InputTesturl()
        UCDN1.CreateUCDN_InputSource(source=u"源站域名")
